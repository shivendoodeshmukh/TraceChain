...
installChaincodes() {
  ...
  if [ -n "$(ls "$CHAINCODES_BASE_DIR/./chaincode/productTokenContract")" ]; then
    ...
    chaincodeInstall "cli.manufacturer.example.com" "peer0.manufacturer.example.com:7061" "productTokenContract" "$version" ""
    chaincodeApprove "cli.manufacturer.example.com" "peer0.manufacturer.example.com:7061" "distribution" "productTokenContract" "$version" "orderer0.group1.orderer.example.com:7030" "" "false" "" ""
    printHeadline "Installing 'productTokenContract' for Distributor" "U1F60E"
    chaincodeInstall "cli.distributor.example.com" "peer0.distributor.example.com:7081" "productTokenContract" "$version" ""
    chaincodeInstall "cli.distributor.example.com" "peer1.distributor.example.com:7082" "productTokenContract" "$version" ""
    chaincodeApprove "cli.distributor.example.com" "peer0.distributor.example.com:7081" "distribution" "productTokenContract" "$version" "orderer0.group1.orderer.example.com:7030" "" "false" "" ""
    printItalics "Committing chaincode 'productTokenContract' on channel 'distribution' as 'Manufacturer'" "U1F618"
    chaincodeCommit "cli.manufacturer.example.com" "peer0.manufacturer.example.com:7061" "distribution" "productTokenContract" "$version" "orderer0.group1.orderer.example.com:7030" "" "false" "" "peer0.manufacturer.example.com:7061,peer0.distributor.example.com:7081" "" ""
  else
